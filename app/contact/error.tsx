...
export default function Error({ error, reset }: ErrorProps) {
    useEffect(() => {
        ...
        console.error('Contact page error caught:', error);
    }, [error]);
            ...
            <div className="max-w-md w-full bg-white p-8 text-center">
                <div className="mb-6">
                    ...
                    <p className="text-gray-600 mb-6">
                        We encountered an issue loading the contact page. Please try again or reach out to us directly.
                    </p>
                </div>
                ...
                <div className="mt-6 p-4 bg-blue-50 rounded-md">
                    <p className="text-sm text-blue-800">
                        ...
                        Email: contact@newsboard.com<br />
                        Phone: (555) 123-4567
                    </p>
                </div>
